...
IUSE="daap +dvd flickr freebox gnome-online-accounts lua subtitles thetvdb tracker upnp-av +vimeo +youtube chromaprint"
...
src_configure() {
	...
	rm -fr "${S}"/usr/share/help
}

src_install() {
	gnome2_src_install

	rm -fr "${ED}/usr/share/help"
}
