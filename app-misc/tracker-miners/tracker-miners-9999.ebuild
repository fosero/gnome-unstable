...
inherit gnome2-utils meson python-any-r1 systemd xdg git-r3

DESCRIPTION="Collection of data extractors for Tracker/Nepomuk"
HOMEPAGE="https://wiki.gnome.org/Projects/Tracker"
EGIT_REPO_URI="https://gitlab.gnome.org/GNOME/tracker-miners.git"

LICENSE="GPL-2+ LGPL-2.1+"
SLOT="3"
IUSE="cue debug exif ffmpeg gif gsf +gstreamer iptc +iso +jpeg +pdf +playlist raw +rss seccomp test +tiff upower +xml xmp xps"
